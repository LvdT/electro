...
This can be seen to be the convolution of \(\varrho_1\) and \(\mathcal{X}\), which
should become a product if we analyse the response in Fourier space.
We define our Fourier transforms as follows.
\begin{equation}
  \begin{matrix*}[l]
  f\of{\vec{k},\omega} &=& \displaystyle \iiiint f\of{\vec{r},t} e^{-\icmp \vec{k} \cdot r} e^{\icmp \omega t} \de^3r\de t \\[1em]
  f\of{\vec{r},t} &=& \displaystyle \frac{1}{\of{2\pi}^4}\iiiint f\of{\vec{k},\omega} e^{-\icmp\of{\vec{k} \cdot r - \omega t}} \de^3k\de \omega
  \end{matrix*}
\end{equation}
With these definitions no additional factors appear in the convolution theorem.
\[\mathcal{Y}_1\of{\vec{k},\omega} = \varrho_1\of{\vec{k},\omega}\mathcal{X}\of{\vec{k},\omega}\]
...
\[\mathcal{Y}_n\of{\vec{k},\omega} = \int\!\!\!\dots\!\!\!\int
\frac{\varrho_n\of{\offf{\vec{k}_m},\offf{\omega_m}}}{\of{2\pi}^{4n-4}} \prod_{j=1}^n \mathcal{X}\of{\vec{k}_j,\omega_j} \delta\of{\vec{k} - \textstyle
...
\[\mathcal{Y}_n\of{\vec{k},\omega} = \int\!\!\!\dots\!\!\!\sideset{}{'}\int
\frac{\varrho_n\of{\offf{\vec{k}_m},\offf{\omega_m}}}{\of{2\pi}^{4n-4}} \prod_{j=1}^n \mathcal{X}\of{\vec{k}_j,\omega_j} \de^3k_j \de\omega_j\]
...
\begin{align*}
\mathcal{Y}_2\of{\vec{k},\omega} &= \frac{1}{\of{2\pi}^4} \iiiint \varrho_n\of{\vec{k}_1,\vec{k}-\vec{k}_1,\omega_1,\omega-\omega_1}
\mathcal{X}\of{\vec{k}_1,\omega_1} \mathcal{X}\of{\vec{k}-\vec{k}_1,\omega-\omega_1} \de^3 k_1 \de \omega_1\\
\mathcal{Y}_2\of{\vec{k},\omega} &= \frac{1}{\of{2\pi}^4} \iiiint \varrho_n\of{\vec{k}-\vec{k}_2,\vec{k}_2,\omega-\omega_2,\omega_2}
